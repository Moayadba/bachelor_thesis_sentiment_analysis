...
df_1 = pd.read_excel('/Users/baset/Desktop/Kursanis Thesis/classfied/sample_1.xlsx')
df_1['Ticker'] = 'GME'
df_1 = df_1.rename(columns={'full_text_processed': 'text_processed'})
df_1 = df_1[['id', 'Ticker', 'full_text', 'text_processed', 'sentiment']]

df_2 = pd.read_excel('/Users/baset/Desktop/Kursanis Thesis/classfied/sample_1_unique.xlsx')

df_3 = pd.read_excel('/Users/baset/Desktop/Kursanis Thesis/classfied/sample_2_unique.xlsx')
df_3 = df_3.loc[df_3['Ticker'] == "GME"]

df_4 = pd.read_csv('/Users/baset/Desktop/Kursanis Thesis/classfied/GME_negative.csv')
df_4 = df_4.drop('model_sentiment', axis=1)
df_4 = df_4.drop('Unnamed: 0', axis=1)
df_4 = df_4.drop('index', axis=1)
df_4['Ticker'] = 'GME'

df_5 = pd.read_excel('/Users/baset/Desktop/Kursanis Thesis/classfied/df_validate_GME_only_gpt_curie_4000.xlsx')
df_5 = df_5.loc[df_5["sentiment"] == 'NEGATIVE']
df_5 = df_5.drop('model_sentiment', axis=1)
df_5['Ticker'] = 'GME'

df_6 = pd.read_excel('/Users/baset/Desktop/Kursanis Thesis/classfied/df_validate_GME_only_gpt_curie_300_4000.xlsx')
...
df_GME_complete_training.to_csv("/Users/baset/Desktop/Kursanis Thesis/classfied/GME_manually_evaluated_complete.csv")
